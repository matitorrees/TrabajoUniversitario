...
{
    public partial class AgregarInquilino : UserControl
    {

        public event GuardarInquilino InquilinoCreado, ActualizarControlInquilino;
        Inquilino p;
        ...
        private void BtnGuardar_Click(object sender, EventArgs e) //Guardar
        {
            ...
            try
            {
                ...
                p = new Inquilino(nroProp, textBoxNombreProf.Text, dni, tel, cel, mail, richTextBoxComProf.Text);

                if (InquilinoCreado(p))
                {
                    ActualizarControlInquilino(p);
                    this.textBoxCelProf.Clear();
                    this.textBoxDniProf.Clear();
                    this.textBoxMailProf.Clear();
                    this.textBoxNombreProf.Clear();
